...
DEPLOY_PARAMS='{"createNatGateway":{"value":<CREATE NAT GATEWAY>},"vnetName":{"value":"<VIRTUAL NETWORK NAME>"},"numSubnets":{"value":<NUM SUBNETS>},"vnetAddressPrefix":{"value":"<VNET ADDRESS PREFIX>"},"tagValues":{"value":{"application":"APP","cost":"COST","environment":"ENV","group":"GROUP","owner":"OWNER"}}}'
