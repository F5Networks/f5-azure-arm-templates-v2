...
storage_account_fqdn=$(az storage account create -n ${storage_account_name} -g <RESOURCE GROUP> -l <REGION> --allow-blob-public-access true | jq -r .primaryEndpoints.blob)
